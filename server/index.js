...
console.log(process.env.KNEX_HOST)

var knex = require('knex')({
  client: 'pg',
  connection: {
    host: process.env.TEST_KNEX_HOST || process.env.KNEX_HOST,
    user: process.env.TEST_KNEX_USER_DATABASE || process.env.KNEX_USER_DATABASE,
    password: process.env.TEST_KNEX_PASSWORD || process.env.KNEX_PASSWORD,
    database: process.env.TEST_KNEX_USER_DATABASE || process.env.KNEX_USER_DATABASE
  },
  // debug: true,
  pool: { min: 0, max: 3 }
});
