    ...
    return (
      <div className="bingomatic">
        <div className="wrapper">
          <header>
            <h1>Binge-<img className="eye" src={BrightEye} alt="o" />-matic</h1>
          </header>
          <Nav />
          {this.props.children}
        </div>
        ...
        <footer className="footer">
          <img src={TMDB} alt="poster" />This product uses the TMDb API but is not endorsed or certified by TMDb.
