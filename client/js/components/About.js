...
const About = (props) => {
  return (
    <main>
      ...
      <p>Go now! <button id="create-btn" onClick={() => { props.dispatch(setPage('newList')); }}>Create a list.</button>
The future of television beckons you.</p>
      </div>
      <div className="card-actions">
        <button className="" onClick={() => { props.dispatch(setPage('newList')); }}>CREATE A LIST</button>
      </div>
      </div>
    </main>
  );
